...
Instructions db ' ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ ',13,10
         ...
         db 'Û        Good luck, Get ready! the player    ',13,10
		 db 'Û        starts in the gray point            ',13,10
...
mov cx,50     ; give the user time to see the screen before move
waitLoop:
...
proc LoadLevel2 ;changing picture to level2Maze
    ...
    call  loadPic
	mov [levelFinished],0
    mov cx,30     ; give the user time to see the screen b4 move
@@waitLoop:
	call _100MiliSecDelay
	loop @@waitLoop
	pop cx
